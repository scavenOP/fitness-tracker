...
@Component({
    ...
    <div class="page-container">
      ...
      <header class="dash-header glass">
        <div class="header-left">
          <img src="assets/mobile_logo.png" alt="FitTrack Pro" class="header-logo" />
          <div>
  ...
  styles: [`
    ...
    .header-logo { width: 40px; height: 40px; object-fit: contain; border-radius: 10px; filter: drop-shadow(0 0 8px rgba(108,99,255,0.4)); }
